  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button
        ...
        @click="
          downloadUrl(
            'test/old/downloadtemplate?filename=oldinfotemplate.xlsx&oldname=template.xlsx'
          )
        "
        >老人信息模板下载</el-button
      >
    ...
    <!-- <el-table-bar> -->
      ...
      >
        ...
        <el-table-column label="床号" class-name="status-col" align="center">
          <template slot-scope="{ row }">
        ...
        <el-table-column label="认知状态" align="center">
          <template slot-scope="{ row }">
        ...
        <el-table-column label="personId" align="center" v-if="false">
          <template slot-scope="{ row }">
            <span>{{ row.id }}</span>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    // 因为是从oldlist出发，所以页面中会带有一个oldlist
    downloadUrl(url) {
